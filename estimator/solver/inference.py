...
print("keypoints confidence", kptsconf)
print("bboxes confidence", bboxesconf)
print("bboxes", bboxes)
frame, all_colors = bbox_kpts_viz.draw_bbox_keypoints(frame, bboxes, kpts, classes, classes_name, show_image=False, wait=False)
bbox_kpts_viz.draw_confidence_scores(frame, bboxesconf, kptsconf, classes, classes_name, colors=all_colors)